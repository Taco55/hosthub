---
name: hosthub-styling
description: >
  Use when creating or modifying themes, colors, typography, or visual styling in
  the HostHub console. Triggers on: theming, theme preset, ThemeData, ColorScheme,
  TextTheme, brightness, dark mode, light mode, palette, HosthubThemePreset,
...
`AGENTS_CORE.md` for the reasoning and the exceptions.
