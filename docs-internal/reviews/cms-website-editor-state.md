...
## next_lens
RUN 8 loopt: G1, G2, G3 en G5 done. G3b done — **de structurele blokkade is weg**: kaarten én padtabel zitten per template. Volgende: **G4** (labels als data — de laatste openstaande slice) (labels als data), G6 (media-routing), G7 (`page`-kolom), G8 (adres-manifest).
