-- Baseline schema reconstructed from PRODUCTION (project dygmamjqvajmpvhwtpye) on 2026-07-23.
-- Source: pg_dump --schema=public --schema-only (prod PG 17.6).
-- NOTE: local-dev reconstruction only. Do NOT 'supabase db push' this to remote —
--       the remote already has this schema; pushing would try to recreate it.
