...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m11(locale) => "Display name (${locale})";

  static String m12(role) => "Role: ${role}";

  static String m13(date) => "Since ${date}";

  static String m14(name) => "Edit template details ${name}";

  static String m15(code) => "Field name (${code})";

  static String m16(count) =>
      "${count} ${Intl.plural(count, one: 'field', other: 'fields')}";

  static String m17(path) => "Default seed directory: ${path}";

  static String m18(path) => "JSON saved to ${path}";

  static String m19(code) => "Locale ${code}";

  static String m20(code) => "List name (${code})";

  static String m21(code) => "Plural name (${code})";
  ...
  static String m24(error) => "Couldn\'t load user: ${error}";

  static String m25(error) => "Couldn\'t load users: ${error}";

  static String m26(time) => "Last sync: ${time}";

  static String m27(error) => "Login failed: ${error}";

  static String m28(error) => "Couldn\'t update the password: ${error}";

  static String m29(error) => "Couldn\'t load profile: ${error}";

  static String m30(propertyName) =>
      "Revenue for ${propertyName} from Lodgify bookings.";

  static String m31(quarter, year) => "Quarter ${quarter} ${year}";

  static String m32(error) => "Failed to load sites: ${error}";

  static String m33(defaultLocale, locales) =>
      "Locale: ${defaultLocale} • Locales: ${locales}";

  static String m34(status) => "Subscription: ${status}";
  ...
  static String m36(error) => "Couldn\'t update admin access: ${error}";

  static String m37(error) => "Couldn\'t update profile: ${error}";

  static String m38(error) => "Couldn\'t delete user: ${error}";
