...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m10(fieldType) =>
      "Veld is gekoppeld aan veld van type \'${fieldType}\'";

  static String m11(locale) => "Weergavenaam (${locale})";

  static String m12(role) => "Rol: ${role}";

  static String m13(date) => "Sinds ${date}";

  static String m14(name) => "Wijzig template-gegevens ${name}";

  static String m15(code) => "Veldnaam (${code})";

  static String m16(count) =>
      "${count} veld${Intl.plural(count, one: '', other: 'en')}";

  static String m17(path) => "Standaard seed-map: ${path}";

  static String m18(path) => "JSON opgeslagen in ${path}";

  static String m19(code) => "Taal ${code}";

  static String m20(code) => "Lijstnaam (${code})";

  static String m21(code) => "Meervoudige naam (${code})";

  static String m22(count) =>
      "${count} voorbeeld${Intl.plural(count, one: 'item', other: 'items')}";

  static String m23(prod, dev) => "${prod} prod / ${dev} dev";

  static String m24(error) => "Kon gebruiker niet laden: ${error}";

  static String m25(error) => "Kon gebruikers niet laden: ${error}";

  static String m26(time) => "Laatste sync: ${time}";

  static String m27(error) => "Inloggen mislukt: ${error}";

  static String m28(error) => "Kon wachtwoord niet wijzigen: ${error}";

  static String m29(error) => "Kon profiel niet laden: ${error}";

  static String m30(propertyName) =>
      "Opbrengsten voor ${propertyName} uit Lodgify boekingen.";

  static String m31(quarter, year) => "Kwartaal ${quarter} ${year}";

  static String m32(error) => "Sites laden mislukt: ${error}";

  static String m33(defaultLocale, locales) =>
      "Taal: ${defaultLocale} • Talen: ${locales}";

  static String m34(status) => "Abonnement: ${status}";

  static String m35(table) =>
  ...
  static String m36(error) => "Kan adminrechten niet wijzigen: ${error}";

  static String m37(error) => "Kon profiel niet bijwerken: ${error}";

  static String m38(error) => "Kon gebruiker niet verwijderen: ${error}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "listsLocaleLabel": m19,
    "listsLocaleListName": m20,
    "listsLocaleListNamePlural": m21,
    ...
    "listsSamplesSingle": m22,
    "listsSamplesSplit": m23,
    ...
    "passwordChangeFailedWithReason": m28,
    ...
    "userDeleteFailedWithReason": m38,
