...
const Map<String, String> emailTemplateFallbacks = {
...
class LocalEmailTemplatesAdapter implements EmailTemplatesPort {
  const LocalEmailTemplatesAdapter();
  ...
  Future<void> sendLoginOtpEmail(
    ...
    throw _notConfiguredError('sendLoginOtpEmail');
  }
  ...
  Future<void> sendSignUpConfirmationEmail(
    ...
    throw _notConfiguredError('sendSignUpConfirmationEmail');
  }
  ...
  Future<void> sendUserCreatedEmail(
    ...
    throw _notConfiguredError('sendUserCreatedEmail');
  }
  ...
  Future<void> sendPasswordResetEmail(
    ...
    throw _notConfiguredError('sendPasswordResetEmail');
  }

  DomainError _notConfiguredError(String action) {
    return DomainError.of(
      DomainErrorCode.serviceUnavailable,
      reason: DomainErrorReason.emailSendFailed,
      message: 'Email delivery not configured for $action.',
    );
  }
}
