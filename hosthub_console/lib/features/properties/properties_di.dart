...
void registerPropertiesDependencies(SupabaseClient client) {
  ...
  if (!I.isRegistered<AccountChannelDefaultsRepository>()) {
    I.registerSingleton<AccountChannelDefaultsRepository>(
      AccountChannelDefaultsRepository(supabase: client),
      signalsReady: true,
    );
  }
}
