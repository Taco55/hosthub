...
class SimplifiedDioInterceptor implements Interceptor {
  ...
  late final bool _logApiRequest;
  late final bool _logResponseBody;

  late final bool _logRequestBody;

  late final void Function(String log) _logger;

  late final Styles requestStyle;
  late final Styles responseStyle;
  ...
  void _logRequest(RequestOptions options, {Styles? style}) {
    _log(key: '[Request] ->', value: '', style: requestStyle);
  ...
  void onError(DioException err, ErrorInterceptorHandler handler) {
    _logError(err, style: errorStyle);
    if (err.response != null) {
      logResponse(err.response!, error: true, style: errorStyle);
    }
    _logNewLine();
  ...
  void onRequest(RequestOptions options, RequestInterceptorHandler handler) {
    if (_logApiRequest) {
      _logRequest(options, style: requestStyle);
      _logNewLine();
    }
